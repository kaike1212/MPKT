...
def process_raw_data(dataset_name,dname2paths):
    ...
    if dataset_name == "codeforces_strong" or "newcf":
        from .codeforces_strong_preprocess import read_data_from_csv
    '''
    ...
    elif dataset_name == "codeforces_test":
        from .codeforces_test_preprocess import read_data_from_csv
    elif dataset_name == "codeforces_strong":
        from .codeforces_strong_preprocess import read_data_from_csv
    elif dataset_name == "BePKT":
        from .BePKT_preprocess import read_data_from_csv
