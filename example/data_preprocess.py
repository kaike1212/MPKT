...
from pykt.preprocess.split_datasets_code import main as split_code_concept
from pykt.preprocess.split_datasets_que import main as split_question
from pykt.preprocess.split_datasets_code_que import main as split_code_question
...
dname2paths = {
    ...
    "codeforces_test": "../data/codeforces/test/codeforces_all.csv",
    "codeforces_strong": "../data/codeforces/strong/codeforces_all.csv",
    "BePKT": "../data/BePKT/BePKT_all.csv",
    "newcf":"../data/codeforces/newcf/codeforces_all.csv",
}
configf = "../configs/data_config.json"

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("-d", "--dataset_name", type=str, default="newcf")
    ...
    # 分割为多个序列
    # split_code_concept(dname,writef,args.dataset_name,configf,args.min_seq_len,args.maxlen, args.kfold)
    ...
    # split_code_question(dname, writef, args.dataset_name, configf, args.min_seq_len,args.maxlen, args.kfold)
